...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductDto createWithCategory(ProductDto productDto, String categoryId) {
        ...
        Categories category = (Categories) categoryRepository.findById(categoryId).orElseThrow(() -> new ResourceNotfoundException("Category not found !!"));
        Product product = mapper.map(productDto, Product.class);
    ...
    public ProductDto updateCategory(String productId, String categoryId) {
        ...
        Categories categories = (Categories) categoryRepository.findById(categoryId).orElseThrow(() -> new ResourceNotfoundException("Category of given id not found !!"));
    ...
    public PageableResponse<ProductDto> getAllOfcategory(String categoryId,int pageNumber,int pageSize,String sortBy, String sortDir) {
        ...
        Sort sort = (sortDir.equalsIgnoreCase("desc")) ? (Sort.by(sortBy).descending()): (Sort.by(sortBy).ascending());
        Pageable pageable = (Pageable) PageRequest.of(pageNumber,pageSize,sort);
        Page<Product> page = productRepository.findByCategory((Category) category, pageable);
        return Helper.getPageableResponse(page,ProductDto.class);
    }
